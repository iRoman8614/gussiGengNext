        ...
        <div className={styles.root}>
            ...
            <div className={styles.cardSet}>
                <Image
                    ...
                    width={100}
                    height={155}
                    style={clickCount1 > 0 && { boxShadow: `0 0 20px 10px rgba(252,192,46)` }}
                    className={
                        clickCount1 === 0
                            ? styles.oneCard1
                            : clickCount1 === 1
                ...
                <Image
                    ...
                    width={100}
                    height={155}
                    style={clickCount2 > 0 && { boxShadow: `0 0 20px 10px rgba(252,192,46)` }}
                    className={
                        clickCount2 === 0
                            ? styles.oneCard2
                            : clickCount2 === 1
                ...
                <Image
                    ...
                    width={100}
                    height={155}
                    style={clickCount3 > 0 && { boxShadow: `0 0 20px 10px rgba(252,192,46)` }}
                    className={
                        clickCount3 === 0
                            ? styles.oneCard3
                            : clickCount3 === 1
                ...
                <Image
                    ...
                    width={100}
                    height={155}
                    style={clickCount4 > 0 && { boxShadow: `0 0 20px 10px rgba(252,192,46)` }}
                    className={
                        clickCount4 === 0
                            ? styles.oneCard4
                            : clickCount4 === 1
